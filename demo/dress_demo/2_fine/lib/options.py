...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_sample.add_argument('--num_sample_inout', type=int, default=16000, help='# of sampling points')
        ...
        g_model.add_argument('--mlp_dim', nargs='+', default=[257, 1024, 1024, 512, 256, 128, 32, 5], type=int,
