...
class TestDataset_Refine(Dataset):
    ...
    def __init__(self, opt, phase='train'):
        ...
        self.B_MIN = np.array([-180, -180, -180])
        self.B_MAX = np.array([180, 180, 180])
    ...
    def select_sampling_method(self, subject):
        ...
        sample_dict = dict(np.load(os.path.join(self.root.replace("thuman2_36views_1", "thuman2_sample"), 
