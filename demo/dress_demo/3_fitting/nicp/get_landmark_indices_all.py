...
root = "outputs/temp/boundary_fitting_outputs/"
out_root = "formated_data/"

src_mapping_dir = "src_landmark/"
boundary = dict(np.load("boundary.npz", allow_pickle=True)["arr_0"][()])
for name in os.listdir(root):
    ...
    trimesh.Trimesh(vertices=trg.vertices[all_trg_landmarks], faces=[[0,1,2]], process=False).export("checks/trg_lm_points.obj")
